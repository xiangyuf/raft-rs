...
pub struct ConfChange {
    ...
    pub node_id: u64,
    pub context: ::std::vec::Vec<u8>,
    pub state: ::protobuf::SingularPtrField<ConfState>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl ConfChange {
    ...
    // Param is passed by value, moved
    pub fn set_state(&mut self, v: ConfState) {
        self.state = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_state(&mut self) -> &mut ConfState {
    ...
    // Take field
    pub fn take_state(&mut self) -> ConfState {
        self.state.take().unwrap_or_else(|| ConfState::new())
    }

    pub fn get_state(&self) -> &ConfState {
        self.state.as_ref().unwrap_or_else(|| ConfState::default_instance())
    }
}
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<ConfState>>(
                    "state",
                    |m: &ConfChange| { &m.state },
                    |m: &mut ConfChange| { &mut m.state },
                ));
...
impl ::protobuf::ProtobufEnum for ConfChangeType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<ConfChangeType> {
        match value {
            ...
            3 => ::std::option::Option::Some(ConfChangeType::SetNodes),
            _ => ::std::option::Option::None
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    try_type\x18\x01\x20\x01(\x0e2\x12.eraftpb.EntryTypeR\tentryType\x12\x12\
    ...
    \x18\x05\x20\x01(\x08R\x07syncLog\"o\n\x10SnapshotMetadata\x121\n\nconf_\
    ...
    \x0cR\x04data\x125\n\x08metadata\x18\x02\x20\x01(\x0b2\x19.eraftpb.Snaps\
    hotMetadataR\x08metadata\"\xe7\x02\n\x07Message\x12/\n\x08msg_type\x18\
    \x01\x20\x01(\x0e2\x14.eraftpb.MessageTypeR\x07msgType\x12\x0e\n\x02to\
    \x18\x02\x20\x01(\x04R\x02to\x12\x12\n\x04from\x18\x03\x20\x01(\x04R\x04\
    from\x12\x12\n\x04term\x18\x04\x20\x01(\x04R\x04term\x12\x19\n\x08log_te\
    rm\x18\x05\x20\x01(\x04R\x07logTerm\x12\x14\n\x05index\x18\x06\x20\x01(\
    \x04R\x05index\x12(\n\x07entries\x18\x07\x20\x03(\x0b2\x0e.eraftpb.Entry\
    R\x07entries\x12\x16\n\x06commit\x18\x08\x20\x01(\x04R\x06commit\x12-\n\
    ...
    mmit\x18\x03\x20\x01(\x04R\x06commit\"=\n\tConfState\x12\x14\n\x05nodes\
    \x18\x01\x20\x03(\x04R\x05nodes\x12\x1a\n\x08learners\x18\x02\x20\x03(\
    \x04R\x08learners\"\xb3\x01\n\nConfChange\x12\x0e\n\x02id\x18\x01\x20\
    \x01(\x04R\x02id\x128\n\x0bchange_type\x18\x02\x20\x01(\x0e2\x17.eraftpb\
    .ConfChangeTypeR\nchangeType\x12\x17\n\x07node_id\x18\x03\x20\x01(\x04R\
    \x06nodeId\x12\x18\n\x07context\x18\x04\x20\x01(\x0cR\x07context\x12(\n\
    \x05state\x18\x05\x20\x01(\x0b2\x12.eraftpb.ConfStateR\x05state*1\n\tEnt\
    ryType\x12\x0f\n\x0bEntryNormal\x10\0\x12\x13\n\x0fEntryConfChange\x10\
    \x01*\x8c\x03\n\x0bMessageType\x12\n\n\x06MsgHup\x10\0\x12\x0b\n\x07MsgB\
    eat\x10\x01\x12\x0e\n\nMsgPropose\x10\x02\x12\r\n\tMsgAppend\x10\x03\x12\
    \x15\n\x11MsgAppendResponse\x10\x04\x12\x12\n\x0eMsgRequestVote\x10\x05\
    ...
    \x01\x02\x12\x03\x05\x16\x17\n\xdd\x04\n\x02\x04\0\x12\x04\x12\0\x1c\x01\
    \x1a\xd0\x04\x20The\x20entry\x20is\x20a\x20type\x20of\x20change\x20that\
    \x20needs\x20to\x20be\x20applied.\x20It\x20contains\x20two\x20data\x20fi\
    elds.\n\x20While\x20the\x20fields\x20are\x20built\x20into\x20the\x20mode\
    l;\x20their\x20usage\x20is\x20determined\x20by\x20the\x20entry_type.\n\n\
    \x20For\x20normal\x20entries,\x20the\x20data\x20field\x20should\x20conta\
    in\x20the\x20data\x20change\x20that\x20should\x20be\x20applied.\n\x20The\
    \x20context\x20field\x20can\x20be\x20used\x20for\x20any\x20contextual\
    \x20data\x20that\x20might\x20be\x20relevant\x20to\x20the\n\x20applicatio\
    n\x20of\x20the\x20data.\n\n\x20For\x20configuration\x20changes,\x20the\
    \x20data\x20will\x20contain\x20the\x20ConfChange\x20message\x20and\x20th\
    e\n\x20context\x20will\x20provide\x20anything\x20needed\x20to\x20assist\
    \x20the\x20configuration\x20change.\x20The\x20context\n\x20if\x20for\x20\
    the\x20user\x20to\x20set\x20and\x20use\x20in\x20this\x20case.\n\n\n\n\
    \x03\x04\0\x01\x12\x03\x12\x08\r\n\x0b\n\x04\x04\0\x02\0\x12\x03\x13\x04\
    \x1d\n\r\n\x05\x04\0\x02\0\x04\x12\x04\x13\x04\x12\x0f\n\x0c\n\x05\x04\0\
    \x02\0\x06\x12\x03\x13\x04\r\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03\x13\x0e\
    \x18\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\x13\x1b\x1c\n\x0b\n\x04\x04\0\
    \x02\x01\x12\x03\x14\x04\x14\n\r\n\x05\x04\0\x02\x01\x04\x12\x04\x14\x04\
    \x13\x1d\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03\x14\x04\n\n\x0c\n\x05\x04\
    \0\x02\x01\x01\x12\x03\x14\x0b\x0f\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\
    \x14\x12\x13\n\x0b\n\x04\x04\0\x02\x02\x12\x03\x15\x04\x15\n\r\n\x05\x04\
    \0\x02\x02\x04\x12\x04\x15\x04\x14\x14\n\x0c\n\x05\x04\0\x02\x02\x05\x12\
    ...
    \x04\x12\x04\x17\x04\x16\x13\n\x0c\n\x05\x04\0\x02\x04\x05\x12\x03\x17\
    \x04\t\n\x0c\n\x05\x04\0\x02\x04\x01\x12\x03\x17\n\x11\n\x0c\n\x05\x04\0\
    \x02\x04\x03\x12\x03\x17\x14\x15\nm\n\x04\x04\0\x02\x05\x12\x03\x1b\x04\
    \x16\x1a`\x20Deprecated!\x20It\x20is\x20kept\x20for\x20backward\x20compa\
    tibility.\n\x20TODO:\x20remove\x20it\x20in\x20the\x20next\x20major\x20re\
    lease.\n\n\r\n\x05\x04\0\x02\x05\x04\x12\x04\x1b\x04\x17\x16\n\x0c\n\x05\
    \x04\0\x02\x05\x05\x12\x03\x1b\x04\x08\n\x0c\n\x05\x04\0\x02\x05\x01\x12\
    ...
    \0\x04\x12\x04\x1f\x04\x1e\x1a\n\x0c\n\x05\x04\x01\x02\0\x06\x12\x03\x1f\
    \x04\r\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03\x1f\x0e\x18\n\x0c\n\x05\x04\
    \x01\x02\0\x03\x12\x03\x1f\x1b\x1c\n\x0b\n\x04\x04\x01\x02\x01\x12\x03\
    ...
    \x05\x01\x02\x0e\x12\x038\x04\x17\n\x0c\n\x05\x05\x01\x02\x0e\x01\x12\
    ...
    \x01\x12\x03c\x13\x1e\n\x0c\n\x05\x04\x06\x02\x01\x03\x12\x03c!\"\n*\n\
    \x04\x04\x06\x02\x02\x12\x03e\x04\x17\x1a\x1d\x20Used\x20be\x20AddNode,\
    ...
    \x03\x12\x03f\x14\x15\n\x1f\n\x04\x04\x06\x02\x04\x12\x03h\x04\x18\x1a\
    \x12\x20Used\x20by\x20SetNodes\n\n\r\n\x05\x04\x06\x02\x04\x04\x12\x04h\
    \x04f\x16\n\x0c\n\x05\x04\x06\x02\x04\x06\x12\x03h\x04\r\n\x0c\n\x05\x04\
    \x06\x02\x04\x01\x12\x03h\x0e\x13\n\x0c\n\x05\x04\x06\x02\x04\x03\x12\
    \x03h\x16\x17b\x06proto3\
";
